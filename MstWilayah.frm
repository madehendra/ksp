...
Begin VB.Form MstWilayah 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid1 
         ...
         Columns(1).Caption=   "NAMA WILAYAH"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "MstWilayah.frx":0BBC
      End
   End
End
Attribute VB_Name = "MstWilayah"
...
Private Sub HapusData()
  If MsgBox("Data benar-benar dihapus...?", vbQuestion + vbYesNo) = vbYes Then
    objData.Delete GetDSN, "WILAYAH", "Kode", sisAssign, cKode.Text
  End If
  initvalue
  GetSQL
  GetEdit False
...
Private Sub cmdPreview_Click()
  GetRptMaster "WILAYAH", "DAFTAR WILAYAH", "NAMA WILAYAH"
End Sub
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "WILAYAH", "Kode='" & cKode.Text & "'", vaField, vaValue
    GetSQL
    initvalue
    GetEdit False
   Else
...
Private Sub GetSQL()
  Set dbData = objData.Browse(GetDSN, "WILAYAH", , , , , , "Kode")
