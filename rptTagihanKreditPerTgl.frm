...
Begin VB.Form rptTagihanKreditPerTgl 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "TAGIHAN KREDIT PER TANGGAL"
   ClientHeight    =   5535
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11790
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin VB.OptionButton optKredit 
         Caption         =   "Harian"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptTagihanKreditPerTgl.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptTagihanKreditPerTgl.frx":00A6
      End
   End
End
Attribute VB_Name = "rptTagihanKreditPerTgl"
...
Dim n As Single
  ...
  cSQL = cSQL & " where d.statuspencairan = 1 and d.caraangsuran = '" & IIf(optKredit(0).Value = True, "B", "H") & "' and d.status <> '1'"
  ...
  If Not dbData.eof Then
    ...
    Do While Not dbData.eof
      FrmPB.RunPB
      If IsInPeriode(objData, GetNull(dbData!Tgl), GetNull(dbData!Lama)) Then
...
Private Function IsInPeriode(ByVal obj As CodeSuiteLibrary.data, ByVal TglRealisasi As Date, ByVal LamaAngsuran As Integer) As Boolean
Dim n As Integer
...
Private Sub GetRpt()
  With FrmRPT
    .AddPageHeader "LAPORAN TAGIHAN KREDIT", tdbHalignCenter, , , , , 12, True
