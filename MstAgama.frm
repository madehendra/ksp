...
Begin VB.Form MstAgama 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "MstAgama.frx":0BBC
      End
   End
End
Attribute VB_Name = "MstAgama"
...
Private Sub HapusData()
  If MsgBox("Data benar-benar dihapus...?", vbQuestion + vbYesNo) = vbYes Then
    objData.Delete GetDSN, "AGAMA", "Kode", sisAssign, cKode.Text
  End If
  initvalue
  GetSQL
  GetEdit False
...
Private Sub cmdPreview_Click()
  GetRptMaster "AGAMA", "DAFTAR AGAMA", "NAMA AGAMA"
End Sub
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "AGAMA", "Kode='" & cKode.Text & "'", vaField, vaValue
    GetSQL
    initvalue
    GetEdit False
   Else
...
Private Sub GetSQL()
  Set dbData = objData.Browse(GetDSN, "AGAMA", , , , , , "Kode")
