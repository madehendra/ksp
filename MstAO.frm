...
Begin VB.Form MstAO 
   ...
   Caption         =   "MASTER ACCOUNT OFFICER"
   ClientHeight    =   6195
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11715
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid TDBGrid1 
         ...
         Columns(2).DataField=   "ALAMAT"
         Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(3)._VlistStyle=   0
         Columns(3)._MaxComboItems=   5
         Columns(3).Caption=   "KOTA"
         Columns(3).DataField=   "KOTA"
         Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(4)._VlistStyle=   0
         Columns(4)._MaxComboItems=   5
         Columns(4).Caption=   "TELEPON"
         Columns(4).DataField=   "TELEPON"
         Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
         Columns(5)._VlistStyle=   0
         Columns(5)._MaxComboItems=   5
         Columns(5).Caption=   "PROVINSI"
         Columns(5).DataField=   "PROVINSI"
         ...
         Splits(0)._ColumnProps(6)=   "Column(1).Width=5424"
         Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=5345"
         Splits(0)._ColumnProps(9)=   "Column(1)._ColStyle=516"
         Splits(0)._ColumnProps(10)=   "Column(1).Order=2"
         Splits(0)._ColumnProps(11)=   "Column(2).Width=6112"
         Splits(0)._ColumnProps(12)=   "Column(2).DividerColor=0"
         Splits(0)._ColumnProps(13)=   "Column(2)._WidthInPix=6033"
         Splits(0)._ColumnProps(14)=   "Column(2)._ColStyle=516"
         Splits(0)._ColumnProps(15)=   "Column(2).Order=3"
         Splits(0)._ColumnProps(16)=   "Column(3).Width=5080"
         Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=5001"
         Splits(0)._ColumnProps(19)=   "Column(3)._ColStyle=516"
         Splits(0)._ColumnProps(20)=   "Column(3).Order=4"
         Splits(0)._ColumnProps(21)=   "Column(4).Width=3916"
         Splits(0)._ColumnProps(22)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(23)=   "Column(4)._WidthInPix=3836"
         Splits(0)._ColumnProps(24)=   "Column(4)._ColStyle=516"
         Splits(0)._ColumnProps(25)=   "Column(4).Order=5"
         Splits(0)._ColumnProps(26)=   "Column(5).Width=4842"
         Splits(0)._ColumnProps(27)=   "Column(5).DividerColor=0"
         Splits(0)._ColumnProps(28)=   "Column(5)._WidthInPix=4763"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "MstAO.frx":0BBC
      End
   End
End
Attribute VB_Name = "MstAO"
...
Private Sub cKode_Validate(Cancel As Boolean)
  If cKode.LastKey = 13 Then
    Set dbData = objData.Browse(GetDSN, "AO", , "Kode", sisAssign, cKode.Text)
...
Private Sub GetMemory()
  ...
  cProvinsi.Text = GetNull(dbData!Provinsi, "")
End Sub
...
Private Sub DeleteData()
  If MsgBox("Data Benar-benar Dihapus ?", vbYesNo) = vbYes Then
     objData.Delete GetDSN, "AO", "Kode", sisAssign, cKode.Text
     GetSQL
  End If
  initvalue
  GetEdit False
...
Dim vaArray As New XArrayDB
  ...
  Set dbData = objData.Browse(GetDSN, "AO", "Kode,Nama,ALamat,Telepon,Kota,Provinsi", , , , , "Kode")
  If Not dbData.eof Then
    vaArray.LoadRows dbData.GetRows(dbData.RecordCount)
  End If
  
  With FrmRPT
    .AddPageHeader "DAFTAR ACCOUNT OFFICER", tdbHalignCenter, , , True, dbArial, 12, True
    .AddPageHeader " ", , , , True
    .AddPageHeader " ", , , , True
    ...
    .AddTableHeader "TELEPON", , , , 10
    .AddTableHeader "KOTA", , , , 11
    .AddTableHeader "PROVINSI", , , , 11
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    If MsgBox("Data benar-benar sudah Valid ?", vbYesNo) = vbYes Then
      vaField = Array("Kode", "Nama", "Alamat", "Telepon", "Kota", "Provinsi")
      vaValue = Array(cKode.Text, cNama.Text, cAlamat.Text, cTelepon.Text, cKota.Text, cProvinsi.Text)
      objData.Update GetDSN, "AO", "Kode = '" & cKode.Text & "'", vaField, vaValue
      GetSQL
    Else
      cKode.SetFocus
      Exit Sub
...
Static Function ValidSaving() As Boolean
  ...
  If Not CheckData(cKode.Text, "Kode AO Harus Diisi, Silahkan Mengulangi Pengisian") Then
    ValidSaving = False
    cKode.SetFocus
    Exit Function
  End If
...
Private Sub GetSQL()
  Set dbData = objData.Browse(GetDSN, "AO", , , , , , "Kode")
