...
Begin VB.Form trHapusMutasiDeposito 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trHapusMutasiDeposito.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdRefresh 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trHapusMutasiDeposito.frx":00A6
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "trHapusMutasiDeposito.frx":0250
      End
   End
End
Attribute VB_Name = "trHapusMutasiDeposito"
