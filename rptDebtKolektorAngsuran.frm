...
Begin VB.Form rptDebtKolektorAngsuran 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Debt Kolektor - Angsuran"
   ClientHeight    =   2100
   ClientLeft      =   45
   ClientTop       =   345
   ClientWidth     =   7710
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDebtKolektorAngsuran.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "rptDebtKolektorAngsuran.frx":00A6
      End
   End
End
Attribute VB_Name = "rptDebtKolektorAngsuran"
...
Dim n As Integer
  ...
  cSQL = "select d.ao,o.nama as namaao,a.tgl,a.rekening,r.nama,a.pokok,a.bunga,a.denda from angsuran a"
  cSQL = cSQL & " left join debitur d on d.rekening = a.rekening"
  cSQL = cSQL & " left join registernasabah r on r.kode = d.kode"
  cSQL = cSQL & " left join ao o on o.kode = d.ao"
  cSQL = cSQL & " where a.tgl >= '" & Format(dDate(0).Value, "yyyy-MM-dd") & "' and a.tgl <= '" & Format(dDate(1).Value, "yyyy-MM-dd") & "'"

  If Check1.Value = 1 Then
    cSQL = cSQL & " and d.ao = '" & cKolektor.Text & "'"
  End If
  
  cSQL = cSQL & " order by d.ao,a.tgl"
  ...
  If Not dbData.eof Then
    Do While Not dbData.eof
      ...
      vaArray(n, 7) = GetNull(dbData!denda)
