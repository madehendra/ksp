...
Begin VB.Form FrmSetupPeriodeBunga 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame2 
      ...
      Begin TrueOleDBGrid70.TDBGrid DataGrid1 
         ...
         Splits(0)._ColumnProps(16)=   "Column(3).Width=4075"
         Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
         Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=3995"
         ...
         _StyleDefs(49)  =   "Splits(0).Columns(3).Style:id=50,.parent=13,.alignment=2"
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdHapus 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmSetupPeriodeBunga.frx":0000
      End
      Begin BiSAButtonProject.BiSAButton cmdSimpan 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmSetupPeriodeBunga.frx":028A
      End
      Begin BiSAButtonProject.BiSAButton cmdEdit 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmSetupPeriodeBunga.frx":06A0
      End
      Begin BiSAButtonProject.BiSAButton cmdAdd 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmSetupPeriodeBunga.frx":07CC
      End
      Begin BiSAButtonProject.BiSAButton cmdKeluar 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "frmSetupPeriodeBunga.frx":0977
      End
   End
End
Attribute VB_Name = "FrmSetupPeriodeBunga"
...
Private Sub cKode_Validate(Cancel As Boolean)
  If cKode.LastKey = 13 Or cKode.LastKey = 40 Then
     Set dbData = objData.Browse(GetDSN, "Periodebungatabungan", "Kode,Bulan,Tahun,Status", "Kode", sisAssign, cKode.Text)
...
Private Sub initvalue()
  cKode.Default
  nBulan.Value = Month(Date)
  nTahun.Value = Year(Date)
  Opt(0).Value = True
End Sub

Private Sub HapusData()
  If MsgBox("Data benar-benar dihapus...?", vbQuestion + vbYesNo) = vbYes Then
    objData.Delete GetDSN, "PERIODEBUNGATABUNGAN", "Kode", sisAssign, cKode.Text
  End If
  initvalue
  GetSQL
  GetEdit False
...
Private Sub GetMemory()
  ...
  If GetNull(dbData!status) = "0" Then
    Opt(0).Value = True
  Else
    Opt(1).Value = True
  End If
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    vaField = Array("Kode", "Bulan", "Tahun", "Status")
    vaValue = Array(cKode.Text, nBulan.Value, nTahun.Value, IIf(Opt(0).Value = True, "0", "1"))
    objData.Update GetDSN, "PeriodeBungatabungan", "Kode='" & cKode.Text & "'", vaField, vaValue
    GetSQL
    initvalue
    GetEdit False
   Else
...
Dim n As Integer
  ...
  Set dbData = objData.Browse(GetDSN, "PERIODEBUNGATABUNGAN", , , , , , "Kode")
  If Not dbData.eof Then
    dbData.MoveFirst
    Do While Not dbData.eof
      ...
      vaArray(n, 3) = IIf(GetNull(dbData!status) = "0", "Aktif", "Tidak Aktif")
      dbData.MoveNext
    Loop
  End If
