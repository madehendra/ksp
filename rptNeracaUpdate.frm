...
Begin VB.Form rptNeracaUpdate 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame1 
      ...
      Begin TrueDBReports60Ctl.TDBReports RptNeraca 
         ...
         Parameters(2).Name=   "cNamaMengetahui"
         Parameters(3).Name=   "cNamaPembuat"
         Parameters(4).Name=   "cJabatanPemeriksa"
         Parameters(5).Name=   "cJabatanPembuat"
         Fields.Count    =   6
         Fields(0).Name  =   "Kode"
         ...
         Sections(5).Cells(6).Name=   "CELL_7"
         Sections(5).Cells(6).Exp=   """"""
         Sections(5).Cells(6).NewLine=   -1  'True
         Sections(5).Cells(6).Width=   33
         Sections(5).Cells(6).Height=   100
         Sections(5).Cells(6).AutoHeight=   0   'False
         Sections(5).Cells(6).PrivateStyle=   -1  'True
         Sections(5).Cells(6).Style.Name=   "<private>"
         Sections(5).Cells(6).Style.ParentName=   "tdb_Pengesahan"
         Sections(5).Cells(6).Style.Font_Name=   "Arial"
         ...
         Sections(5).Cells(6).Style.TextAlign=   1
         Sections(5).Cells(6).Style.TextVAlign=   0
         ...
         Sections(5).Cells(6).Style.fprops=   0
         Sections(5).Cells(7).Name=   "CELL_8"
         Sections(5).Cells(7).Exp=   """"""
         Sections(5).Cells(7).Width=   33
         Sections(5).Cells(7).Height=   100
         Sections(5).Cells(7).AutoHeight=   0   'False
         Sections(5).Cells(7).PrivateStyle=   -1  'True
         Sections(5).Cells(7).Style.Name=   "<private>"
         Sections(5).Cells(7).Style.ParentName=   "tdb_Pengesahan"
         Sections(5).Cells(7).Style.Font_Name=   "Arial"
         ...
         Sections(5).Cells(7).Style.TextAlign=   1
         Sections(5).Cells(7).Style.TextVAlign=   0
         ...
         Sections(5).Cells(7).Style.fprops=   0
         Sections(5).Cells(8).Name=   "CELL_9"
         Sections(5).Cells(8).Exp=   """"""
         Sections(5).Cells(8).Width=   33
         Sections(5).Cells(8).Height=   100
         Sections(5).Cells(8).AutoHeight=   0   'False
         Sections(5).Cells(8).PrivateStyle=   -1  'True
         Sections(5).Cells(8).Style.Name=   "<private>"
         Sections(5).Cells(8).Style.ParentName=   "tdb_Pengesahan"
         Sections(5).Cells(8).Style.Font_Name=   "Arial"
         Sections(5).Cells(8).Style.Font_Size=   8.25
         ...
         Sections(5).Cells(8).Style.TextAlign=   1
         Sections(5).Cells(8).Style.TextVAlign=   0
         ...
         Sections(5).Cells(8).Style.MarginTop=   6
         Sections(5).Cells(8).Style.MarginRight=   6
         Sections(5).Cells(8).Style.MarginBottom=   6
         ...
         Sections(5).Cells(8).Style.NoClipping=   -1  'True
         Sections(5).Cells(8).Style.RTF=   0   'False
         Sections(5).Cells(8).Style.fprops=   0
         ...
         Sections(5).Cells(14).Name=   "CELL_21"
         Sections(5).Cells(15).Name=   "CELL_22"
         Sections(5).Cells(15).NewLine=   -1  'True
         Sections(5).Cells(16).Name=   "CELL_23"
         Sections(5).Cells(17).Name=   "CELL_24"
         Sections(5).Cells(18).Name=   "CELL_25"
         Sections(5).Cells(18).NewLine=   -1  'True
         Sections(5).Cells(19).Name=   "CELL_26"
         Sections(5).Cells(20).Name=   "CELL_27"
         Sections(5).Cells(21).Name=   "CELL_10"
         Sections(5).Cells(21).Exp=   "cNamaMengetahui"
         Sections(5).Cells(21).NewLine=   -1  'True
         Sections(5).Cells(21).Width=   33
         Sections(5).Cells(22).Name=   "CELL_11"
         Sections(5).Cells(22).Width=   33
         Sections(5).Cells(23).Name=   "CELL_12"
         Sections(5).Cells(23).Exp=   "cNamaPembuat"
         Sections(5).Cells(23).Width=   33
         Sections(5).Cells(24).Name=   "CELL_13"
         Sections(5).Cells(24).Exp=   "cJabatanPemeriksa"
         Sections(5).Cells(24).NewLine=   -1  'True
         Sections(5).Cells(24).Width=   33
         Sections(5).Cells(25).Name=   "CELL_14"
         Sections(5).Cells(25).Width=   33
         Sections(5).Cells(26).Name=   "CELL_15"
         Sections(5).Cells(26).Exp=   "cJabatanPembuat"
         Sections(5).Cells(26).Width=   33
         Styles.Count    =   25
...
Dim nAwalLaba As Double
  ...
  ' Ambil Data Rekening
  Set dbData = objData.Browse(GetDSN, "Rekening", "Kode,Keterangan", "Kode", sisLT, "4", , "Kode")
...
'      ElseIf left(dbData!Rekening, 1) <> 6 Then
...
'************************************************
  ...
  If Not dbData.eof Then
    ...
    Do While Not dbData.eof
      ...
      ElseIf TypeRekening(dbData!Rekening) <> SisAdministratif Then
        n = vaNeraca.Find(0, 0, cRekening)
        If n >= 0 Then
  ...
  Set vaFilter = vaNeraca
  Dim dbTmp As New ADODB.Recordset
  Dim i As Integer
  Dim k(100)
  Dim ki As Integer
  Dim batal As Boolean
  Dim rekfilter As String

  On Error Resume Next
  ki = 0
  batal = False
  For n = vaFilter.LowerBound(1) To vaFilter.UpperBound(1)
    If Len(vaFilter(n, 0)) = 5 Then
      Set dbTmp = objData.Browse(GetDSN, "rekening", , , , , " 1=1 and kode like '" & vaFilter(n, 0) & ".%'")
      'jika ada data maka proses jika tidak ada maka otomatis batal
      If Not dbTmp.eof Then
        Do While Not dbTmp.eof
          i = vaNeraca.Find(0, 0, GetNull(dbTmp!Kode))
          If i > 0 Then
            'batal
            'exit do
            batal = True
  ...
  With RptNeraca
    ...
    If aCfg(msOptTampilkanFootNoteNeraca) = 1 Then
      .Parameters(2).Value = aCfg(msNamaPemeriksaNeraca)
      .Parameters(3).Value = aCfg(msNamaPembuatNeraca)
      .Parameters(4).Value = aCfg(msJabatanPemeriksaNeraca)
      .Parameters(5).Value = aCfg(msJabatanPembuatNeraca)
    End If
    .PrintPreview
  End With
End Sub
