...
Begin VB.Form MstPDL 
   ...
   Begin BiSAFramProject.BiSAFrame BiSAFrame3 
      ...
      Begin BiSAButtonProject.BiSAButton cmdPreview 
         ...
         Alignment       =   1
         BackColor       =   -2147483633
         Picture         =   "MstPDL.frx":0BBC
      End
   End
End
Attribute VB_Name = "MstPDL"
...
Private Sub HapusData()
  If MsgBox("Data benar-benar dihapus...?", vbQuestion + vbYesNo) = vbYes Then
    objData.Delete GetDSN, "PDL", "Kode", sisAssign, cKode.Text
  End If
  initvalue
  GetSQL
  GetEdit False
...
Private Sub cmdPreview_Click()
  GetRptMaster "PDL", "DAFTAR PDL", "NAMA PDL"
End Sub
...
Dim vaField, vaValue
  ...
  If ValidSaving() Then
    ...
    objData.Update GetDSN, "PDL", "Kode='" & cKode.Text & "'", vaField, vaValue
    GetSQL
    initvalue
    GetEdit False
   Else
...
Private Sub GetSQL()
  Set dbData = objData.Browse(GetDSN, "PDL", , , , , , "Kode")
